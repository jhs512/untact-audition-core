...
public class KakaoApiController {
    ...
    static {
        ...
        adminApiPaths.add("/v2/local/search/address.json");
    }
    ...
    public String kakaoLocalApi(@RequestParam String keyword) {
       accessToken = "963fb3b5a85268d25eacc8506acff30c";
       String query = urlEncodeUTF8(keyword);
       String rs = request(HttpMethodType.GET, "/v2/local/search/address.json" , "?query=" + query);
